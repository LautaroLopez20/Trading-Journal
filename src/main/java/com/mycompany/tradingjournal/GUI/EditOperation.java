...
public class EditOperation extends javax.swing.JFrame {
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        controller.update(this.op,date,stopLoss,takeProfit,priceOut,priceIn,percentajeRisk,annotation,active,market,trend,type);
    ...
    private void ShowValues() {
        ...
        if(op != null) {
            jSpinnerDate.setValue(Date.from(op.getDate().atStartOfDay(ZoneId.systemDefault()).toInstant()));
